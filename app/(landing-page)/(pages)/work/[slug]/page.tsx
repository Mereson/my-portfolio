	...
	return (
		<section className={`bg-white p-20`}>
			{isLoading ? (
				<SkeletonLoader
					variant="solid"
					customClassName="w-7xl h-[45.223rem] rounded-4xl shadow-lg"
				/>
			) : (
				<figure className="rounded-4xl">
					<Image
						...
						width={1280}
						height={723}
						className="w-7xl h-[45.223rem] rounded-4xl shadow-lg bg-[#00000062]"
						alt="work"
					/>
				</figure>
			)}
			...
			{isLoading ? (
				<article className="m-8 mt-12 grid gap-3">
					<SkeletonLoader
						variant="solid"
						customClassName="w-xl h-[2.4rem] mb-2 rounded-lg"
					/>
					<div className="grid gap-2">
						<SkeletonLoader
							variant="solid"
							customClassName="w-full h-7 rounded-lg"
						/>
						<SkeletonLoader
							variant="solid"
							customClassName="w-full h-7 rounded-lg"
						...
						<SkeletonLoader
							variant="solid"
							customClassName="w-full h-7 rounded-lg mt-9"
						/>
						<SkeletonLoader
							variant="solid"
							customClassName="w-full h-7 rounded-lg"
